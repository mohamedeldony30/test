...
async(Void, citel, text) => 
{
    let  waifuddfg = await axios.get(`https://nekos.life/api/V1/img/fox_girl`);
...
cmd({
    ...
    async(Void, citel, text) => {
        ...
        let URL1 = `https://newsapi.org/V1/everything?q=${q1}&domains=techcrunch.com,animenewsnetwork.com,myanimelist.net,comingsoon.net,crunchyroll.com&language=en&sortby=publishedat&apikey=cd4116be09ef4a0caceedf21b6258460&pageSize=8`;
