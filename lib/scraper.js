...
if (fs.existsSync('./Themes/' + Config.LANG + '.json')) {	
	...
	var json = JSON.parse(fs.readFileSync('./LANG/Zenon.json'));	
}	
...
let check = await notes.find({})	
     ...
     let gudbmro = i	
     leadtext += `${gudbmro+1} *❄️⃝🧚‍♀️الـرقـم✨┇* ${check[i].id}\n*❄️⃝🧚‍♀️الـمـلاحـظـه📝┇* ${check[i].note}\n\n`	
	...
	return new Promise((resolve,reject) => {	
		axios.get('https://www.instagram.com/'+ username +'/?__a=1',{	
			...
			headers: {	
				...
				"cookie": "mid=XBXl1AALAAEbFoAEfNjZlMMG9dwX; ig_did=91E66A48-5AA2-445D-BFE6-84DC4456DE8F; fbm_124024574287414=base_domain=.instagram.com; ig_nrcb=1; shbid=\"12737\0544008624962\0541656157971:01f72a5102dc07af6845adf923ca70eb86e81ab95fa9dbfdaf157c9eef0e82fd1f10fe23\"; shbts=\"1624621971\0544008624962\0541656157971:01f74841fba8e77a0066b47ea891dec8fba6fdf9216c0816f9fb3532292f769828800ae2\"; fbsr_124024574287414=86D8femzH4_KFW4hd3Z6XFdowU6lG-uXsXRQDNl44VM.; fbsr_124024574287414=86D8femzH4_KFW4hd3Z6XFdowU6lG-uXsXRQDNl44VM.; csrftoken=PpiPMEl0R2pAwThsw4NXynO6cVIXHZDo; ds_user_id=38316792800; sessionid=38316792800:rQj5Tr3g5zkg7b:4; rur=\"RVA\05438316792800\0541656158332:01f759cf624bef147397144805bb4c26f6c8b36a232e0f5738c570ee492f6b629f84f6e5\""	
			}	
		})	
		.then( async data => {	
